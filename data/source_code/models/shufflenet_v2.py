...
from models.slim import g_name
...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, num_classes, width_multiplier):
        ...
        width_config = {
            0.25: (24, 48, 96, num_classes),
            0.33: (32, 64, 128, num_classes),
            0.5: (48, 96, 192, num_classes),
            1.0: (116, 232, 464, num_classes),
        ...
        self.network_config = [
            ...
            slim.conv_bn_relu('stage1/conv', 3, in_channels, 1, 2, 1),
            ...
            g_name('pool', nn.AdaptiveAvgPool2d((1, 1))),
        ]
        self.network = []
